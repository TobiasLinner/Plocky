...
const localShops: LocalShop[] = [
  {
    ...
    hours: "11:00 - 13:00",
    description:
      "Lokal gård som säljer köttlådor och styckdetaljer från gårdens djur. Förhandsbeställ eller köp i gårdsbutiken.",
  ...
  },
  {
    ...
    hours: "09:00 - 16:00",
    description:
      "Litet gårdsmejeri som säljer färsk mjölk, ost och yoghurt i gårdsbutiken.",
  ...
  },
  {
    ...
    description:
      "Säsongsöppet självplock av jordgubbar och smultron. Hinkar finns att köpa på plats.",
  ...
  },
  {
    ...
    description:
      "Stor åker där självplock av potatis är möjligt under sensommaren. Guidade helger vid behov.",
  ...
  },
  {
    ...
    description:
      "Familjevänligt majsfält med självplock och grillplats under utvalda helger.",
